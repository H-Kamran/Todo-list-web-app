    ...
    <>
      <div className="task-card flex ">
        ...
        <div className="task-container text-left ml-2">
          <h3 className="task-title text-lg font-bold">akbkwja</h3>
          <p className="task-desc text-sm opacity-70">dajkwhjabdjbwabdawdwa</p>
          <div className="task-details flex items-end">
            <div className="date-container ">
              <img src={schedule} className="w-3.5 inline" />
              <p className="date inline-block ml-1 text-sm opacity-70">Today</p>
            </div>
